...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT) // fala que é uma classe de teste
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
public class UsuarioControllerTest {

	@Autowired
	private TestRestTemplate testRestTemplate; // dependencia de uma classe que tem função de requisições, funciona como
												// a controller, da um caminho para realizarmos testes
	...
	@BeforeAll // execute esse método antes de qualquer outro
	void start() {

		usuarioRepository.deleteAll(); // limpa o banco de dados

		usuarioService.cadastrarUsuario(new Usuario(0L, "Root", "root@root.com", "rootroot", "-"));

	}

	@Test // esse método é um teste
	@DisplayName("Cadastrar Um Usuário") // coloca nome no método
	public void deveCriarUmUsuario() {

		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(
				new Usuario(0L, "Kemilly", "kemilly@email.com", "12345678", "-"));
